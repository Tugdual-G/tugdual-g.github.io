...
let fragmentShaderSource = `#version 300 es
    ...
    // 71, 171, 171
    // 2, 185, 219
    vec3 c0 = vec3(2.0/255.0, 215.0/255.0, 250.0/255.0);
    // 255, 255, 224
    // vec3 c1 = vec3(255.0/255.0, 255.0/255.0, 224.0/255.0);
    vec3 c1 = vec3(255.0/255.0, 255.0/255.0, 235.0/255.0);
    ...
    float sdf = sdTriangle(getLocalCoord(texCoord));
    float dist_c0 = exp(-pow(sdf, 2.0)/0.001);
    float edge = gaussFilter(tex, texCoord);
    dist_c0 = dist_c0 > edge ? dist_c0 : edge;
    vec3 c =  c1 * dist_c0 + c0 * (1.0 - dist_c0);
    c.x += 0.2 + 0.2 * sin(15.0 * sdf + t);
